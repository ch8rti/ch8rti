...
<head>
  ...
  <title>Влад — видеомонтажёр</title>
  <style>
    :root{
      --bg:#040912;
      --bg-soft:#08111d;
    ...
    *{box-sizing:border-box}
    ...
    .nav-links{
      display:flex; align-items:center; gap:34px; color:#dce7f2;
    }
    ...
    .cta, .ghost-btn, .chip-btn, .project-link{
    ...
    .cta:hover, .ghost-btn:hover, .chip-btn:hover, .project-link:hover{transform:translateY(-2px)}
    ...
    h1{
      margin:0 0 16px;
      max-width:760px;
      font-size:74px; line-height:1.01; letter-spacing:-.06em;
    }
    ...
    .soft-orb{
      position:absolute; border-radius:50%; filter:blur(12px);
      background:radial-gradient(circle, rgba(36,133,255,.34), transparent 68%);
    ...
    .project-card:hover, .review-card:hover{
      ...
      box-shadow:0 28px 68px rgba(0,0,0,.44), 0 0 34px rgba(36,133,255,.12);
      border-color:rgba(99,176,255,.22);
    }
    ...
    .project-cover::after{
      ...
      background:conic-gradient(from 180deg, transparent, rgba(99,176,255,.18), transparent 30%);
...
box-shadow:0 6px 18px rgba(0,0,0,0.25);
    ...
    .project-link, .ghost-btn, .chip-btn{
      display:inline-flex; align-items:center; justify-content:center;
    ...
    .chip{
      ...
      font-size:14px; color:#c8d5e3;
      background:rgba(255,255,255,.04);
      border:1px solid rgba(255,255,255,.06);
    }

    .about-card{
      max-width:980px; padding:34px;
    }
    ...
    .about-card::after{
      ...
      border-radius:50%;
      background:radial-gradient(circle, rgba(36,133,255,.16), transparent 66%);
      pointer-events:none;
    }
    ...
    .review-avatar{
      ...
      box-shadow:inset 0 0 22px rgba(255,255,255,.03), 0 0 20px rgba(36,133,255,.08);
    }

    .review-avatar::before{
      content:"";
      position:absolute; left:50%; top:16px; transform:translateX(-50%);
      width:16px; height:16px; border-radius:50%; background:#d7e3ee;
    }
    ...
    @media (max-width:640px){
      ...
      .cta{height:48px; padding:0 22px}
    ...
    <section id="works" class="section reveal">
      ...
      <div class="projects">
        <article class="project-card">
          ...
          <div class="project-cover open-project" data-project="memory" style="background-image:url('https://img.youtube.com/vi/d7Ow-mqDBMg/maxresdefault.jpg'); background-size:cover; background-position:center;">
        ...
        <article class="project-card">
          ...
          <div class="project-cover open-project" data-project="battle" style="background-image:url('https://img.youtube.com/vi/ExHY8cCCz_g/maxresdefault.jpg'); background-size:cover; background-position:center;">
            <div class="cover-inner">
              <div class="cover-badge">▶ YouTube</div>
              <div class="cover-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z"></path></svg>
